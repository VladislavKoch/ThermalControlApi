...
import static ru.vladkochur.thermalControlApi.util.DataUtils.getFirstSensorPeriodTransient;
import static ru.vladkochur.thermalControlApi.util.DataUtils.getSecondSensorPeriodTransient;
...
class SensorPeriodRepositoryTest {
    ...
    public void givenThreePeriodsInDB_whenFindAllOrderByWeekday_thenOrderedPeriodsAreReturned() {
        //given
        sensorPeriodRepository.save( getFirstSensorPeriodTransient(Weekday.SATURDAY));
        sensorPeriodRepository.save( getFirstSensorPeriodTransient(Weekday.MONDAY));
        sensorPeriodRepository.save( getSecondSensorPeriodTransient(Weekday.WEDNESDAY));
        //when
    ...
    public void givenThreePeriodsInDB_whenFindAllByIsDefaultFalseOrderByWeekday_thenNotDefaultOrderedPeriodsAreReturned() {
        //given
        sensorPeriodRepository.save( getFirstSensorPeriodTransient(Weekday.SATURDAY));
        sensorPeriodRepository.save( getSecondSensorPeriodTransient(Weekday.MONDAY));
        sensorPeriodRepository.save( getSecondSensorPeriodTransient(Weekday.WEDNESDAY));
        //when
    ...
    public void givenThreePeriodsInDB_whenFindByWeekdayAndIsDefault_thenPeriodOptionalIsReturned() {
        ...
        sensorPeriodRepository.save( getFirstSensorPeriodTransient(Weekday.SATURDAY));
        sensorPeriodRepository.save( getSecondSensorPeriodTransient(Weekday.MONDAY));
        sensorPeriodRepository.save( getSecondSensorPeriodTransient(Weekday.SATURDAY));
        //when
