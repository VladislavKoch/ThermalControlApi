...
class MeasurementRepositoryTest {
    ...
    public void givenSensorSerial_whenFindMeasurementsBySensorSerial_thenMeasurementsAreReturned() {
        ...
        Sensor sensor2 = DataUtils.getYaroslavlSensorTransient();
        sensorRepository.save(sensor);
        sensorRepository.save(sensor2);
        measurementRepository.save(DataUtils.getFirstMeasurementTransient(sensor));
        measurementRepository.save(DataUtils.getSecondMeasurementTransient(sensor));
        measurementRepository.save(DataUtils.getThirdMeasurementTransient(sensor2));
        //when
    ...
    public void givenSensorSerial_whenFindLastWeekAvgTemperatureBySensorSerial_thenAvgTemperatureIsReturned() {
        //given
        Sensor sensor1 = DataUtils.getKostromaSensorTransient();
        sensorRepository.save(sensor1);
        Sensor sensor2 = DataUtils.getIvanovoSensorTransient();
        sensorRepository.save(sensor2);
        Measurement m1 = DataUtils.getFirstMeasurementTransient(sensor1);
        Measurement m2 = DataUtils.getSecondMeasurementTransient(sensor1);
        Measurement m3 = DataUtils.getSecondMeasurementTransient(sensor2);

        measurementRepository.save(m1);
        measurementRepository.save(m2);
        measurementRepository.save(m3);
        measurementRepository.save(DataUtils.getThirdMeasurementTransient(sensor1));
        //when
    ...
    public void givenThreeSensorsInDB_whenDeleteByTimeBefore_thenOneMeasurementIsDeleted() {
        Sensor sensor = DataUtils.getKostromaSensorTransient();
        sensorRepository.save(sensor);
        Measurement m1 = DataUtils.getFirstMeasurementTransient(sensor);
        Measurement m2 = DataUtils.getSecondMeasurementTransient(sensor);
        Measurement m3 = DataUtils.getThirdMeasurementPersisted(sensor);
        measurementRepository.save(m1);
        measurementRepository.save(m2);
        measurementRepository.save(m3);
        //when
    ...
    givenThreeSensorsInDB_whenFindMeasurementsBySensor_SerialAndTimeAfterAndTimeBeforeOrderByTime_thenOneMeasurementIsReturned() {
        ...
        Sensor sensor = DataUtils.getKostromaSensorTransient();
        sensorRepository.save(sensor);
        Measurement m = DataUtils.getFirstMeasurementTransient(sensor);
        m.setTime(LocalDateTime.now().plusDays(10));
        measurementRepository.save(m);
        measurementRepository.save(DataUtils.getSecondMeasurementTransient(sensor));
        measurementRepository.save(DataUtils.getThirdMeasurementTransient(sensor));
        //when
        List<Measurement> obtainedMeasurements =
