...
import static ru.vladkochur.thermalControlApi.util.DataUtils.getFirstTelegramInteractionTransient;
...
class TelegramInteractionRepositoryTest {
    ...
    public void givenTelegramId_whenFindByTelegramId_thenTelegramInteractionOptionalIsReturned() {
        //given
        TelegramInteraction interaction =  getFirstTelegramInteractionTransient();
