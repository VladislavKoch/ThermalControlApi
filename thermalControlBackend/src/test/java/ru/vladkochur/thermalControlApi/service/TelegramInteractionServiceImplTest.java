...
import static ru.vladkochur.thermalControlApi.util.DataUtils.getFirstTelegramInteractionPersisted;
...
class TelegramInteractionServiceImplTest {
    ...
    public void givenThreeInteractionInDB_whenGetAllTelegramInteractions_thenRepositoryIsCalled() {
        //given
        List<TelegramInteraction> interactions = List.of( getFirstTelegramInteractionPersisted(),
                 getFirstTelegramInteractionPersisted(),  getFirstTelegramInteractionPersisted());
    ...
    public void givenTelegramInteraction_whenSaveNewTelegramInteraction_thenRepositoryIsCalled() {
        //given
        TelegramInteraction interaction =  getFirstTelegramInteractionPersisted();
