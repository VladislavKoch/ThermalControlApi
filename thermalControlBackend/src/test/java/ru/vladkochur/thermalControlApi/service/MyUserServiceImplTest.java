...
class MyUserServiceImplTest {
    ...
    public void givenThreeUsersInDB_whenFindAllUsers_thenRepositoryIsCalled() {
        //given
        List<MyUser> users = List.of(DataUtils.getFirstUserPersisted(), DataUtils.getSecondUserPersisted(),
                DataUtils.getThirdUserPersisted());
    ...
    public void givenUser_whenSaveUser_thenRepositoryIsCalled() {
        //given
        MyUser user = DataUtils.getFirstUserTransient();
        MyUser user1 = DataUtils.getFirstUserPersisted();
