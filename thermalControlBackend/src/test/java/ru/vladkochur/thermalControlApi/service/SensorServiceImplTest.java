...
class SensorServiceImplTest {
    ...
    public void givenTwoSensors_whenGetAllSensors_thenRepositoryIsCalled() {
        //given
        List<Sensor> sensors = List.of(DataUtils.getKostromaSensorPersisted(), DataUtils.getYaroslavlSensorPersisted());
    ...
    public void givenSensorToUpdate_whenUpdateSensor_thenRepositoryIsCalled() {
        //given
        Sensor sensorToUpdate = DataUtils.getKostromaSensorPersisted();
        Sensor updatedSensor = DataUtils.getKostromaSensorPersisted();
    ...
    public void givenSensorSerial_whenMakeSensorWantedToInteract_thenRepositoryIsCalled() {
        //given
        Sensor sensorThatNotWantToInteract = DataUtils.getKostromaSensorTransient();
    ...
    public void givenTwoSensors_whenFindAllSensorsWantedForInteraction_thenRepositoryIsCalled() {
        //given
        Sensor sensor1 = DataUtils.getKostromaSensorPersisted();
