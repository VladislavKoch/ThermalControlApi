...
class MeasurementRestControllerTest {
    ...
    public void givenMeasurementDTO_whenCreateMeasurement_thenSuccessResponse() throws Exception {
        //given
        SensorDTO sensorDTO = getKostromaSensorDto();
        Sensor sensor = getKostromaSensorPersisted();
        MeasurementDTO measurementDTO = getFirstMeasurementDTO(sensorDTO);
        Measurement measurement = getThirdMeasurementPersisted(sensor);
    ...
    public void givenPanicMeasurementDTO_whenSendCriticalMeasurementToAllUsers_thenSuccessResponse() throws Exception {
        //given
        SensorDTO sensorDTO = getKostromaSensorDto();
        MeasurementDTO measurementDTO = getPanicMeasurementDTO(sensorDTO);
