...
class ItMyUserControllerTest extends AbstractRestControllerBaseTest {
    ...
    public void givenThreeUsers_whenGetAllUsers_thenViewResponse() throws Exception {
        //given
        userRepository.save(DataUtils.getFirstUserTransient());
        userRepository.save(DataUtils.getSecondUserTransient());
        userRepository.save(DataUtils.getThirdUserTransient());
        interactionRepository.save(DataUtils.getFirstTelegramInteractionTransient());
        //when
    ...
    public void givenUserId_whenShowUser_thenViewResponse() throws Exception {
        //given
        MyUser user = userRepository.save(DataUtils.getFirstUserTransient());
        //when
    ...
    public void givenUser_whenGetEditUserForm_thenEditUserViewResponse() throws Exception {
        //given
        MyUser obtainedUser = userRepository.save(DataUtils.getFirstUserTransient());
        //when
    ...
    public void givenUserDTO_whenUpdateUserSetDuplicateLogin_thenErrorUpdateUserViewResponse() throws Exception {
        //given
        userRepository.save(DataUtils.getFirstUserTransient());
        MyUser obtainedUser = userRepository.save(DataUtils.getSecondUserTransient());
        MyUserDTO dto = DataUtils.getSecondUserDTO();
    ...
    public void givenUserDTO_whenUpdateUserSetDuplicateTelegram_thenErrorUpdateUserViewResponse() throws Exception {
        //given
        MyUser duplicateOrigin = userRepository.save(DataUtils.getFirstUserTransient());
        MyUser obtainedUser = userRepository.save(DataUtils.getSecondUserTransient());
